...
1.  Для `RX(α)` на |0⟩:
    ![P(1) = sin^2(\alpha/2)](formula1.png)
    Тогда из наблюдаемой \(P\) можно получить угол (в радианах)
    ![alpha = 2 arcsin(sqrt(P))](formula2.png)
...
![P_90 = 1/2 - 1/2 sin(gamma)](probe_formula1.png)
![P_270 = 1/2 + 1/2 sin(gamma)](probe_formula2.png)
откуда сразу:
![sin(gamma) = P_270 - P_90](probe_formula3.png)
