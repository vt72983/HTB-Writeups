...
**Two verified probe combinations with opposite sines:** instead of `RX:90` + `RY:90`, we now use `RX:90` and `RX:270` (270° = −90°, `sin(270) = -1`). This gives the formulas:
