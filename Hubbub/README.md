...
Моей главнейшей ошибкой заключалась в том, что я считал, что за все задержки отвечает одна-единственная функция. На самом деле прошивка использует **два разных адреса вызова** для двух разных целей:
